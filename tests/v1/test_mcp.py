...
SUPERVISOR_TOOLS = frozenset({
    ...
    "front_done", "front_show", "front_take", "job_fail", "job_repoint", "job_verify", "kill", "launch", "map_add", "map_import", "map_resolve", "map_show", "measure", "merge_request", "milestone_add", "milestone_list", "milestone_merge", "milestone_split", "pool_list", "register",
    "relaunch", "rule",
...
FOREMAN_TOOLS = frozenset({
    "answer", "attach", "checkpoint", "doctor", "front_allocate", "front_show", "inbox",
...
def test_owner_without_a_session_lists_everything_but_the_transport(
    ...
    # front show from the v5 inputs job.
