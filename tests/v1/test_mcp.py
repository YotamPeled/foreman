...
SUPERVISOR_TOOLS = frozenset({
    ...
    "front_done", "front_show", "front_take", "job_fail", "job_repoint", "job_verify", "kill", "launch", "map_add", "map_import", "map_resolve", "map_show", "measure", "merge_request", "node_add", "node_revise", "pool_list", "register",
    "relaunch", "rule",
