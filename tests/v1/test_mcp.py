...
SUPERVISOR_TOOLS = frozenset({
    ...
    "job_fail", "job_verify", "kill", "launch", "measure", "merge_request",
...
def test_owner_without_a_session_lists_everything_but_the_transport(
    ...
    # hook_install, hook_list, migrate. 41 with `kill`, the verb the design
    # gave the owner and this runtime had never shipped. Counted, not
