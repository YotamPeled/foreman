...
SUPERVISOR_TOOLS = frozenset({
    "ask", "checkpoint", "evidence", "finding", "job_fail", "job_verify",
    "launch", "register", "relaunch", "rule", "status", "task_built",
    "task_landed", "task_reset", "version",
})
#: The foreman role's own row: answers and rules, never front or job verbs.
FOREMAN_TOOLS = frozenset({
    "answer", "checkpoint", "inbox", "launch", "register", "relaunch",
    "rule", "status", "version",
})
